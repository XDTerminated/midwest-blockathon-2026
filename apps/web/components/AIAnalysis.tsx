        ...
        <div className="bg-[#1C2030] rounded-[14px] border border-[#363C4A] p-5 shadow-elevated">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-[#9CA3AF] bg-[#121620] border border-[#363C4A] px-2 py-1 rounded">ImmiVault AI</span>
                </div>
            ...
            <div className="text-base text-[#c0c2d0] leading-loose space-y-4">
                <ReactMarkdown
                    components={{
                        p: ({ children }) => <p className="leading-loose">{processCitations(children as string, result.citedCases)}</p>,
                        h2: ({ children }) => <h2 className="text-base font-semibold text-[#e8e8f0] mt-4 mb-1">{children}</h2>,
                        h3: ({ children }) => <h3 className="text-sm font-semibold text-[#e8e8f0] mt-3 mb-1">{children}</h3>,
            ...
            {result.citedCases.length > 0 && (
                <div className="mt-4 pt-4 border-t border-[#D4AD5A]/20">
                    <p className="text-xs text-[#6B7280] uppercase tracking-wide mb-2">Cases Referenced</p>
